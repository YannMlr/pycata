...
export type QuestionActuelleState = Readonly<typeof initialState>;

// Reducer

export default (state: QuestionActuelleState = initialState, action): QuestionActuelleState => {
  switch (action.type) {
...
const apiUrl = 'api/questionActuelle';
