package com.telecom.pycata.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.telecom.pycata.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.telecom.pycata.repository.UserRepository.USERS_BY_EMAIL_CACHE);
